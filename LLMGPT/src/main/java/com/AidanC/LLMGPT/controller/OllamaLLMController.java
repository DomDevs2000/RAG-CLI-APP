...
public class OllamaLLMController {
 ...
 public OllamaLLMController(OllamaLLMService ollamaLLMService, OllamaChatModel ollamaChatModel) {
 ...
 public ResponseEntity<LLMGPTResponse> test(@RequestBody String message) {
  ...
  LLMGPTResponse chatResponse = new LLMGPTResponse(responseContent);
